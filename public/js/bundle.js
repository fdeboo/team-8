      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            console.log("error", _context2.t0.response.data.message);
