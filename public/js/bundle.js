      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 7:
            ...
            console.log("error", _context.t0.response.data); // showAlert("error", err.response.data.message);
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            console.log("error", _context2.t0.response.data.message); // showAlert("error", err.response.data.message);
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 7:
            ...
            console.log("error", err.response.data.message); // showAlert('error', 'Error logging out! Try again.');
...
var workleForm = document.querySelector(".form--workle");
...
if (signupForm) {
  signupForm.addEventListener("submit", function (ev) {
    ...
    (0, _login.signup)(userData);
  });
}

if (workleForm) {
  workleForm.addEventListener("submit", function (ev) {
    ev.preventDefault();
    var radioInputs = document.getElementsByName("emotion");
    var selectedEmotion;

    var _iterator = _createForOfIteratorHelper(radioInputs),
        _step;
    ...
    var emotion = document.getElementById("email").value;
...
},{"./../utils":"zIVT"}],"RlDD":[function(require,module,exports) {
...
},{"./../utils":"zIVT","./../core/settle":"wZW9","./../helpers/cookies":"OhlP","./../helpers/buildURL":"RS1v","../core/buildFullPath":"d0lp","./../helpers/parseHeaders":"T8HP","./../helpers/isURLSameOrigin":"DmB6","../core/createError":"lGrg","../defaults":"T2kP","../cancel/Cancel":"RlDD"}],"rH1J":[function(require,module,exports) {
...
},{"./../utils":"zIVT","./transformData":"i7gz","../cancel/isCancel":"C9l1","../defaults":"T2kP","../cancel/Cancel":"RlDD"}],"Qj6T":[function(require,module,exports) {
...
},{"../env/data":"omJA"}],"RB6n":[function(require,module,exports) {
...
},{"./../utils":"zIVT","../helpers/buildURL":"RS1v","./InterceptorManager":"GGkJ","./dispatchRequest":"U2VI","./mergeConfig":"Qj6T","../helpers/validator":"lMdc"}],"VWBb":[function(require,module,exports) {
